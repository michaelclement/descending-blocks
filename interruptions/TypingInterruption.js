        ...
        choices.forEach((choice, i) => {
            ...
            <div class="flex flex-row flex-wrap content-center align-center items-center mb-2 mt-2">
              ...
              p-[3px] flex justify-between"><span>${this.words[choice]}</span>
                ${this.improveUX ? "\
                  <button class='rounded-md bg-white text-zinc-500 mx-[5px] px-[8px] pb-[2px] flex content-center align-center'>\
              ...
              <input id="s${i}" 
                     ...
                     mx-[10px]">
              ${this.improveUX ? "\
                <button class='rounded-md text-zinc-500 mx-[5px] px-[8px] pb-[2px] flex content-center align-center'>\
